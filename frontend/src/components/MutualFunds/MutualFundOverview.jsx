const MutualFundOverview = ({
  ...
  const roi = parseFloat(totalInvested) > 0
    ? ((profitLossNum / parseFloat(totalInvested)) * 100).toFixed(2)
    : "0.00";
        ...
        <div className="flex items-center justify-between mb-3">
          <div>
            ...
            <p className="text-2xl font-bold text-blue-700">
              ₹{parseFloat(totalInvested).toLocaleString("en-IN", {
        ...
        <div className="flex items-center justify-between mb-3">
          <div>
            ...
            <p className="text-2xl font-bold text-emerald-700">
              ₹{parseFloat(totalCurrentValue).toLocaleString("en-IN", {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
              })}
            </p>
